...
namespace LibraryManagement {
    ...
    public partial class BooksData : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, string Publisher, string Year, string ISBN, string Type, int Copies, int Checkedout) {
...
namespace LibraryManagement.BooksDataTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([BookId] = @Original_BookId) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_Copies = 1 AND [Copies] IS NULL) OR ([Copies] = @Original_Copies)) AND ([Checkedout] = @Original_Checkedout))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Books] ([Title], [Author], [Publisher], [Year], [ISBN], [Type], [Copies], [Checkedout]) VALUES (@Title, @Author, @Publisher, @Year, @ISBN, @Type, @Copies, @Checkedout);
SELECT BookId, Title, Author, Publisher, Year, ISBN, Type, Copies, Checkedout FROM Books WHERE (BookId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Title] = @Title, [Author] = @Author, [Publisher] = @Publisher, [Year] = @Year, [ISBN] = @ISBN, [Type] = @Type, [Copies] = @Copies, [Checkedout] = @Checkedout WHERE (([BookId] = @Original_BookId) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_Copies = 1 AND [Copies] IS NULL) OR ([Copies] = @Original_Copies)) AND ([Checkedout] = @Original_Checkedout));
SELECT BookId, Title, Author, Publisher, Year, ISBN, Type, Copies, Checkedout FROM Books WHERE (BookId = @BookId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookId, Title, Author, Publisher, Year, ISBN, Type, Copies, Checkedout FRO" +
                "M dbo.Books";
        ...
        public virtual int Fill(BooksData.BooksDataTable dataTable) {
        ...
        public virtual BooksData.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BooksData.BooksDataTable dataTable = new BooksData.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BooksData.BooksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_BookId, string Original_Title, string Original_Author, string Original_Publisher, string Original_Year, string Original_ISBN, string Original_Type, global::System.Nullable<int> Original_Copies, int Original_Checkedout) {
            ...
            this.Adapter.DeleteCommand.Parameters[13].Value = ((int)(Original_Checkedout));
        ...
        public virtual int Insert(string Title, string Author, string Publisher, string Year, string ISBN, string Type, global::System.Nullable<int> Copies, int Checkedout) {
            if ((Title == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[7].Value = ((int)(Checkedout));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Checkedout));
            ...
            if ((Original_Copies.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((int)(Original_Copies.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[19].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[20].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Original_Checkedout));
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_Copies, 
                    int Original_Checkedout) {
            return this.Update(Title, Author, Publisher, Year, ISBN, Type, Copies, Checkedout, Original_BookId, Original_Title, Original_Author, Original_Publisher, Original_Year, Original_ISBN, Original_Type, Original_Copies, Original_Checkedout, Original_BookId);
        }
    }
