...
namespace LibraryManagement {
    ...
    public partial class LibaryDBDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, string Publisher, string Year, string ISBN, int Checkedout) {
...
namespace LibraryManagement.LibaryDBDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Books] ([Title], [Author], [Publisher], [Year], [ISBN], [Checkedout]) VALUES (@Title, @Author, @Publisher, @Year, @ISBN, @Checkedout);
SELECT BookId, Title, Author, Publisher, Year, ISBN, Checkedout FROM Books WHERE (BookId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Title] = @Title, [Author] = @Author, [Publisher] = @Publisher, [Year] = @Year, [ISBN] = @ISBN, [Checkedout] = @Checkedout WHERE (([BookId] = @Original_BookId) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)) AND ([Checkedout] = @Original_Checkedout));
SELECT BookId, Title, Author, Publisher, Year, ISBN, Checkedout FROM Books WHERE (BookId = @BookId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookId, Title, Author, Publisher, Year, ISBN, Checkedout FROM dbo.Books";
        ...
        public virtual int Fill(LibaryDBDataSet.BooksDataTable dataTable) {
        ...
        public virtual LibaryDBDataSet.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibaryDBDataSet.BooksDataTable dataTable = new LibaryDBDataSet.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibaryDBDataSet.BooksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_BookId, string Original_Title, string Original_Author, string Original_Publisher, string Original_Year, string Original_ISBN, int Original_Checkedout) {
            ...
            this.Adapter.DeleteCommand.Parameters[9].Value = ((int)(Original_Checkedout));
        ...
        public virtual int Insert(string Title, string Author, string Publisher, string Year, string ISBN, int Checkedout) {
            if ((Title == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(Checkedout));
        ...
        public virtual int Update(string Title, string Author, string Publisher, string Year, string ISBN, int Checkedout, int Original_BookId, string Original_Title, string Original_Author, string Original_Publisher, string Original_Year, string Original_ISBN, int Original_Checkedout, int BookId) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Checkedout));
            ...
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_Checkedout));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, string Publisher, string Year, string ISBN, int Checkedout, int Original_BookId, string Original_Title, string Original_Author, string Original_Publisher, string Original_Year, string Original_ISBN, int Original_Checkedout) {
            return this.Update(Title, Author, Publisher, Year, ISBN, Checkedout, Original_BookId, Original_Title, Original_Author, Original_Publisher, Original_Year, Original_ISBN, Original_Checkedout, Original_BookId);
        }
    }
